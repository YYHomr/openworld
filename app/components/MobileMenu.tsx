...
const menu = {
  en:[
    {title:"Start",links:[["Home","/"],["Latest stories","/#latest"],["War live","/war"],["News by date","/date"],["AI news","/ai"]]},
  ...
  ar:[
    {title:"البداية",links:[["الرئيسية","/ar"],["أحدث القصص","/ar#latest"],["الحرب مباشر","/ar/war"],["الأخبار حسب التاريخ","/ar/date"],["أخبار الذكاء الاصطناعي","/ar/ai"]]},
